package com.ptc.rain.notice.util;
...
public class FileUtils2 {
	...
	public static List<NoticeFileDto> uploadFiles(MultipartFile[] files, int notiNo) {
		...
		List<NoticeFileDto> noticeFileList = new ArrayList<>();
		...
		for (MultipartFile file : files) {
			try {
				...
				noticeFile.setNotiNo(notiNo);
				noticeFile.setOriginalName(file.getOriginalFilename());
				...
				throw new NoticeFileException("[" + file.getOriginalFilename() + "] failed to save file...");
